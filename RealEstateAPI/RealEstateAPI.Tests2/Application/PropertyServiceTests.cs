...
namespace RealEstateAPI.Tests.Application
{
    ...
    {
        private Mock<IMongoDatabase> _mongoDatabase = null!;
        private Mock<PropertyRepository> _mockRepository = null!;
        ...
        public void Setup()
        {
            ...
            _mockRepository = new Mock<PropertyRepository>(_mongoDatabase.Object);
